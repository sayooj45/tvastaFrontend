    ...
    <div className="relative w-full h-[660px] bg-white overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center h-full px-4 z-10">
        ...
        >
          {/* Main Title */}
          <SlideInUp delay={0.3}>
            <h1 className="w-full max-w-[1256px] font-outfit font-semibold text-title-mobile md:text-title text-center tracking-[-0.02em] capitalize text-[#0D192D]">
              Who We Are
            </h1>
          </SlideInUp>
          ...
          {/* Subtitle */}
          <SlideInUp delay={0.5}>
            <p className="w-full max-w-[1086px] font-outfit font-semibold text-card-mobile md:text-description text-center tracking-[-0.02em] text-[#1D3357]">
