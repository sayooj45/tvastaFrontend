        ...
        <div className="flex flex-col gap-[20px] md:gap-[24px] w-full md:w-1/2">
          ...
          <FadeIn delay={0.4} duration={0.8}>
            <p className="text-card-mobile md:text-description font-normal leading-[1.7] text-[#4A4A4A] tracking-[-0.02em]">
              Completed and handed over a fully functional, aesthetically appealing 1BHK house of 500 sq.ft in just 21 days - setting a milestone as India’s first 3D printed home. 
              The project showcased the power of modular 3D construction for rapid, sustainable, and resilient housing during challenging times.
            </p>
          </FadeIn>
        </div>
      </div>
