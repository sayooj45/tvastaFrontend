        ...
        <div className="flex flex-col gap-[20px] md:gap-[24px] w-full md:w-1/2">
          ...
          <FadeIn delay={0.4} duration={0.8}>
            <p className="text-card-mobile md:text-description font-normal leading-[1.7] text-[#4A4A4A] tracking-[-0.02em]">
              Delivered two 750 sq.ft guest house units (total 1,500 sq.ft), combining rapid 3D printed construction, bespoke wall designs, 
              and earthquake-resistant features tailored to the site’s requirements. This project highlights Tvasta’s flexibility in meeting 
              specialized client needs while adapting to complex regional safety standards.
            </p>
          </FadeIn>
        </div>
      </div>
